...
> ⚠️ **AI 协作规则（必读）**
>
> 任何 AI 接手本项目时，必须遵守以下规则：
>
> 1. **接手第一步**：先读 `01-Documentation/Markdown文档汇总/01-项目文档/项目状态/00-PROJECT-STATUS.md`，5 分钟了解当前进度和下一步任务
> 2. **完成任务后必须更新 md 文档**：每完成一个功能/阶段/重大改动后，AI 必须主动检查并更新以下文档：
>    - `00-PROJECT-STATUS.md` - 更新功能完整度、路线图状态、当前要做的下一步
>    - `02-ROADMAP.md` - 完成阶段时更新该阶段的 checkbox 和状态
>    - `08-工作文档/` - 新建排查记录文档（如有遇到问题）
> 3. **不要等用户提醒**：AI 应在任务完成后主动说"我更新了以下 md 文档：xxx"，而不是等用户问"要不要更新文档"
> 4. **memory 同步**：重大架构决策或工程约定变更时，同步更新 `c:\Users\16685\.trae-cn\memory\projects\-d-AI\project_memory.md`
