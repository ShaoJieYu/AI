...
> **新 AI 工程师**：请先读 [项目状态总览](../项目状态/00-PROJECT-STATUS.md)（5 分钟了解当前进度和下一步任务）
...
1. 阅读 [项目状态总览](../项目状态/00-PROJECT-STATUS.md)（10 分钟）—— **必读，5 分钟了解当前进度**
2. 阅读 [Agent 升级路线图](../项目状态/02-ROADMAP.md)（5 分钟）—— **核心任务线**
3. 选角色读对应启动指南（各 5 分钟）：
...
1. **看当前进度**：[项目状态总览](../项目状态/00-PROJECT-STATUS.md) 的"Agent 升级路线图"表格
2. **看四阶段规划**：[Agent 升级路线图](../项目状态/02-ROADMAP.md)
3. **看阶段 1 怎么做的**：[Agent 阶段 1 升级与联调排查记录](../../08-工作文档/Agent阶段1升级与联调排查记录.md)
4. **看 memory 里的路线图**：`c:\Users\16685\.trae-cn\memory\projects\-d-AI\project_memory.md` 的"Agent 升级路线图"区块
...
- [Agent 阶段 1 升级与联调排查记录](../../08-工作文档/Agent阶段1升级与联调排查记录.md) ⭐ **最新**
